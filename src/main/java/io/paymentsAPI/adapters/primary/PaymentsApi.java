...
public interface PaymentsApi {
    ...
    ResponseEntity<Void> deletePaymentById(@ApiParam(value = "ID of an existing payment", required = true) @PathVariable("paymentId") Long paymentId);
    ...
    ResponseEntity<PaymentResponse> getPaymentById(@ApiParam(value = "ID of payment to return", required = true) @PathVariable("paymentId") Long paymentId);
